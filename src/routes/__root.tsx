...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: 'Second Line AI — Never Miss the Money' },
      { name: 'description', content: 'Managed HVAC revenue recovery for residential contractors in Baton Rouge and across Louisiana.' },
      { name: 'theme-color', content: '#0B3D2E' },
      { property: 'og:type', content: 'website' },
      { property: 'og:title', content: 'Second Line AI — Never Miss the Money' },
      { property: 'og:description', content: 'Recover more of the revenue your HVAC company is already paying to generate.' },
      { property: 'og:site_name', content: 'Second Line AI' },
      { property: 'og:locale', content: 'en_US' },
      { property: 'og:image', content: 'https://images.unsplash.com/photo-1625148230889-8195e85aae6b?auto=format&fit=crop&w=1200&q=85' },
      { property: 'og:image:alt', content: 'HVAC professional holding a service tool' },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: 'https://images.unsplash.com/photo-1625148230889-8195e85aae6b?auto=format&fit=crop&w=1200&q=85' },
      { name: 'twitter:title', content: 'Second Line AI — Never Miss the Money' },
      { name: 'twitter:description', content: 'Recover more of the revenue your HVAC company is already paying to generate.' },
    ],
    links: [
      { rel: 'canonical', href: 'https://secondlineai.com/' },
              ...
              '@graph': [
                {
                  '@type': 'WebSite',
                  name: 'Second Line AI',
                  url: 'https://secondlineai.com/',
                  description: 'Managed HVAC revenue recovery for residential contractors in Baton Rouge and across Louisiana.',
                },
                {
                  '@type': ['LocalBusiness', 'ProfessionalService'],
                  name: 'Second Line AI',
                  url: 'https://secondlineai.com/',
                  description: 'A Louisiana-based HVAC revenue recovery partner for residential contractors.',
                  telephone: '+1-225-325-2700',
                  email: 'bookmore@secondlineai.com',
                  serviceType: 'HVAC Revenue Recovery',
